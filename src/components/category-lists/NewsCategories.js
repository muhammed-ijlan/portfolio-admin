...
import Filter from './NewsCategoryFilter';
...
export default function NewsCategories() {
  ...
  const updateCategory = async () => {
    try {
      const res = await axios.put(`${process.env.REACT_APP_API_URL}/news-category`, {
                        ...
                        <TableRow key={id} sx={{ '&:hover': { backgroundColor: '#f5f5f5' } }}>
                          ...
                          <TableCell>
                            <FormControl sx={{ minWidth: 100 }}>
                              ...
                              {selectedIndex === id && (
                                <Popup item={item} path="/news-category/status" handleClose={handleClose} />
                              )}
                            </FormControl>
                          </TableCell>
